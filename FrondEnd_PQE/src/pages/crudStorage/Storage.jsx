              ...
              <div className="flex flex-col items-center justify-center bg-red-600 rounded-lg w-80 h-full">
                ...
                <div className="flex flex-col items-center justify-center bg-white rounded-2xl w-80 h-72 mt-5 mb-6">
                    <form onSubmit={handleSubmit} className="w-full ml-11 mb-2">
                        <label className="block text-black ml-2 mb-1 mt-3" htmlFor="id-rack">Id Rack</label>
                        <TextField id="id-rack" value={idRack} onChange={(e) => setIdRack(e.target.value)} className="w-full mb-4" />

                        <label className="block text-black ml-2 mb-1" htmlFor="rack-capacity">Rack Capacity</label>
                        <TextField id="rack-capacity" value={rackCapacity} onChange={(e) => setRackCapacity(e.target.value)}  className="w-full mb-4" />

                        <label className="block text-black ml-2 mb-1" htmlFor="rack-status">Rack Status</label>
                        <TextField id="rack-status" value={rackStatus} onChange={(e) => setRackStatus(e.target.value)}  className="w-full mb-4" /><br />
