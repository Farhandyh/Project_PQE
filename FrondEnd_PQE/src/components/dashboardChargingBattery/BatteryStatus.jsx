...
import categoryData from "../../dataDummy/dailyBatteryStatus.json"; // Import data from JSON file
...
const CategoryDistributionChart = ({ width, height }) => {
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      legend: {
        position: "left", // Menempatkan legend di sebelah kiri
        labels: {
          color: "#E01414",
        },
      },
